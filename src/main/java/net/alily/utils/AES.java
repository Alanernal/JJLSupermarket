...
/**
 * 加密类 AES
 * Created by Alan on 5/12/17.
 */
public class AES {
    //初始向量
    public static final String VIPARA = "ilove2017mrzishi";   //AES 为16bytes. DES 为8bytes
    //编码方式
    public static final String bm = "UTF-8";
    //私钥
    private static final String ASE_KEY="ilove2017mrzishi";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static void main(String[] args) throws Exception {
        ...
        String content = "asd"; //xf92eOdomA5akNDbutbstA==
        // 加密
